          ...
          <div className="col-md-6">
            ...
            <div className="twoD-p">
              <p>
                ...
                интерпретировать из-за наложения сложных анатомических структур.
                При измерении мы всегда используем запас прочности, чтобы
                компенсировать увеличение, вызванное самой техникой записи, и у
                нас нет информации о ширине (толщине) и точном пространственном
                положении. Однако мы не собираемся клеветать на технологию,
                которая была нашей опорой столько лет и которая уже столько раз
                открывала нам глаза, наоборот, мы думаем, что одно и то же
                2D-изображение будет основой диагностики, планирования и
                контроль в стоматологических кабинетах и ​​его
            ...
            <div className="panorama-record">
              ...
              <p>
                Изображение придаточных пазух носа включает пазухи и окружающие
                их структуры. Их можно записывать в нескольких разных проекциях,
                при этом классическая задне-передняя запись выполняется по
                умолчанию.
              </p>
              <br />
            ...
            <div className="special-record">
              ...
              <p>
                ...
                производиться в профильной проекции LL и во фронтальной проекции
                PA.
              </p>
