  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <hr />
        <div className="row">
          <h3 className="zagrebh-h">ПОЛИЦА</h3>
          <div className="col-md-4">
            <div className="riverphone">
              ...
              <p>
                телефон:{" "}
                <span>
                  <a href="tel: 021/370 235" className="rPhone">
                    {" "}
                    021/370 235
                  </a>
                </span>
            ...
            <div className="riverloc">
              <FontAwesomeIcon
                ...
                id="loc"
              ></FontAwesomeIcon>
              <p>Поличка цеста 19, 21000 Сплита</p>
            </div>
            <div className="riveremail">
              <FontAwesomeIcon
                ...
                className="fa-2x"
              ></FontAwesomeIcon>
              <a href="mailto: xdentpoljicka@gmail.com">
                xdentpoljicka@gmail.com
              </a>
            </div>
          </div>
          <div className="col-md-4">
            <div className="rivertime">
              <h6>Рабочее время</h6>
              <p id="time-p">Понедельник, среда и пятница: с 08:00 до 15:00</p>
              <p id="time-p">Вторник и четверг: 13:00 – 20:00</p>
